      ...
      <>
        <div className="md:flex md:justify-between">
          ...
          <div className="mt-4 md:mt-0 md:ml-4">
            ...
            <p>
              I love learning. I'm particularly interested in making things that combine hardware
              and software, that go up and down the stack, or are in areas like AI and IoT.
            </p>
            <p>
